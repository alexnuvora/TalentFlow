...
Deno.serve(async(req)=>{
 ...
 try{
  ...
  if(name==='get_client_call_context'){
   ...
   return done({client,vacancies:jobs||[],recent_notes:notes||[]});
  }
  if(name==='get_next_dialer_client'){
   ...
   return done({campaign,item,context:{client,vacancies:jobs||[],recent_notes:notes||[]}});
  }
