-- Preserve campaign attribution through to commercial placement records.
-- When a placement is recorded without an explicit campaign, inherit the
-- campaign from the candidate's submitted application for the same job.
