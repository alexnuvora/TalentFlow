...
revoke all on function private.initialise_partner_onboarding_impl(uuid,uuid,text) from public,anon;
grant execute on function private.initialise_partner_onboarding_impl(uuid,uuid,text) to authenticated,service_role;
