...
export default function PartnerOperations({section}:{section:PartnerOpsSection}){
 ...
 const[search,setSearch]=useState(''),[busy,setBusy]=useState(false),[editing,setEditing]=useState<any>(null),[newPipeline,setNewPipeline]=useState({candidate_id:'',job_id:''});
