 ...
 return <div className="page partner-page">
  ...
  <div className="grid two">
   ...
   <Card><h3>Permissions & capabilities</h3>
    <div className="list-row compact"><div><strong>Employer prospecting</strong><span>Create and qualify genuine employer prospects and prepare qualified opportunities.</span></div><Badge tone={statusTone(access.partnerCanProspect)}>{access.partnerCanProspect?'Enabled':'Not assigned'}</Badge></div>
    <div className="list-row compact"><div><strong>Client closing</strong><span>Work assigned approved clients through requirements, manager-authorised TOB and activation.</span></div><Badge tone={statusTone(access.partnerCanCloseClients)}>{access.partnerCanCloseClients?'Enabled':'Not assigned'}</Badge></div>
    <div className="list-row compact"><div><strong>Candidate sourcing</strong><span>Search the controlled candidate database, source candidates, use talent pools and recommend candidates for human review.</span></div><Badge tone={statusTone(access.partnerCanSourceCandidates)}>{candidateAssigned?(access.partnerActive?'Assigned':'Inactive'):'Not assigned'}</Badge></div>
    ...
    <div className="list-row compact"><div><strong>Binding commercial authority</strong><span>Fees, payment terms, guarantees, exclusivity, candidate ownership and contractual variations.</span></div><Badge tone="neutral">Vorlen management only</Badge></div>
   </Card>
  </div>
